package mich.a09_22_testtwofragment.ui.adapters;
...
import mich.a09_22_testtwofragment.ui.fragments.ToolsFragment;
...
public class StoreAdapter extends RecyclerView.Adapter<StoreAdapter.StoreHolder> {
    ...
    static class StoreHolder extends RecyclerView.ViewHolder {
        ...
        public StoreHolder(View itemView) {
            ...
            this.textNameStore = (TextView) itemView.findViewById(R.id.name_store);
            this.textAddressStore = (TextView) itemView.findViewById(R.id.adress_store);
            this.textPhoneStore = (TextView) itemView.findViewById(R.id.phone_store);
        }
    }
    ...
    public StoreHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ltem_store, parent, false);
    ...
    public void onBindViewHolder(StoreHolder holder, int position) {
        ...
        holder.cardStore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ToolsFragment instrumentFragment = new ToolsFragment();
